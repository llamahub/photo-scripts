...
class TestImageAnalyzer:
    ...
    def test_analyze_images_nonexistent_folder(self):
        ...
        with pytest.raises(FileNotFoundError, match=f"Folder not found: {nonexistent_path}"):
    ...
    def test_analyze_single_image_success(self, mock_target, mock_size, mock_ext, 
                                        mock_alt, mock_condition, mock_strip, 
                                        mock_norm_parent, mock_parent, 
                                        mock_filename_date, mock_image_date):
        ...
        mock_target.return_value = "/tmp/2023/2023-06/2023-06-15_1230_1920x1080_2023-06_IMG_001.jpg"
    ...
    def test_analyze_single_image_error(self):
        ...
        with patch.object(ImageData, 'getImageDate', side_effect=Exception("Test error")):
            result = analyzer._analyze_single_image(test_file)
    ...
    def test_integration_analyze_and_save(self):
        ...
        with patch.object(ImageData, 'getImageDate', return_value="2023-06-15 12:30:00"), \
             patch.object(ImageData, 'getFilenameDate', return_value="2023-06-15 00:00:00"), \
             patch.object(ImageData, 'getParentName', return_value="2023-06"), \
             patch.object(ImageData, 'normalize_parent_date', return_value="2023-06-01 00:00:00"), \
             patch.object(ImageData, 'strip_time', side_effect=lambda x: x[:10]), \
             patch.object(ImageData, 'get_condition', return_value=("Test condition", "Match")), \
             patch.object(ImageData, 'extract_alt_filename_date', return_value=""), \
             patch.object(ImageData, 'getTrueExt', return_value="jpg"), \
             patch.object(ImageData, 'getImageSize', return_value=("1920", "1080")), \
             patch.object(ImageData, 'getTargetFilename', return_value="/tmp/target.jpg"):
