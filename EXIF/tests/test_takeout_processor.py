...
class TestTakeoutProcessor:
    ...
    def sample_zip(self, temp_dirs):
        ...
        with tempfile.TemporaryDirectory() as zip_temp:
            ...
            photos_dir = (
                zip_temp_path / "Takeout" / "Google Photos" / "Photos from 2024"
            )
    ...
    def test_is_sidecar_file(self, temp_dirs):
        ...
        assert (
            processor.is_sidecar_file(Path("test.jpg.supplemental-metadata.json"))
            is True
        )
    ...
    def test_extract_zip_contents(self, sample_zip):
        ...
        image_path = extracted_files[
            "Takeout/Google Photos/Photos from 2024/IMG_001.jpg"
        ]
    ...
    def test_parse_sidecar_metadata(self, sample_zip):
        ...
        assert (
            ...
            == expected_metadata["photoTakenTime"]["timestamp"]
        )
