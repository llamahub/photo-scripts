...
def test_get_condition_all_combinations():
    ...
    result = ImageData.get_condition("1900-01-01 00:00", "1900-01-01 00:00", "1900-01-01 00:00")
    assert result[1] == "Match"
...
def test_extract_alt_filename_date_comprehensive():
    ...
    result = ImageData.extract_alt_filename_date(
        Path("/test/folder/20230615_photo.jpg"),
        "2023-06-15 00:00"
    )
    ...
    result = ImageData.extract_alt_filename_date(
        Path("/test/folder/IMG_20230615_123045.jpg"),
        "2023-06-01 00:00"
    )
    ...
    result = ImageData.extract_alt_filename_date(
        Path("/test/folder/random_photo.jpg"),
        "2023-06-15 00:00"
    )
...
def test_getFilenameDate_comprehensive():
    ...
    assert ImageData.getFilenameDate("/path/to/20230615_photo.jpg") == "2023-06-15 00:00"
...
def test_getTargetFilename_comprehensive(monkeypatch, tmp_path):
    ...
    result = ImageData.getTargetFilename(str(test_file), str(tmp_path), label="vacation")
    ...
    monkeypatch.setattr(ImageData, "get_exif", staticmethod(mock_get_exif_different_date))
