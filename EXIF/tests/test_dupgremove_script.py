...
class TestDupGuruRemover:
    ...
    def create_test_csv(self, custom_data=None):
        ...
        if custom_data is None:
            ...
            test_data = [
                ['Group ID', 'Filename', 'Folder', 'Size (KB)', 'Dimensions',
                 'Match %', 'Action', 'Comments'],
                ['0', 'photo1.jpg', 'X:\\2020+\\2022\\2022-06\\2022-06_Photos',
                 '500', '1920 x 1080', '99', 'Delete', 'Duplicate'],
                ['0', 'photo1_organized.jpg', 'X:\\2020+\\2022\\2022-06\\2022-06_DEB',
                 '498', '1920 x 1080', '99', 'Keep', 'Organized format'],
                ['1', 'scan1.jpg', 'X:\\1990+\\1995\\1995-03\\1995-03_Vacation',
                 '800', '2048 x 1536', '98', 'Delete', 'Duplicate scan'],
                ['1', 'scan1_original.jpg', 'X:\\1990+\\1995\\1995-03\\1995-03_Scans',
                 '795', '2048 x 1536', '98', 'Keep', 'Original'],
                ['2', 'duplicate.jpg', 'X:\\2020+\\2025\\2025-10\\NPTSTI~Z',
                 '300', '1080 x 1920', '100', 'Delete', 'Invalid folder'],
                ['2', 'duplicate_good.jpg', 'X:\\2020+\\2025\\2025-10\\2025-10_Photos',
                 '298', '1080 x 1920', '100', 'Keep', 'Valid folder']
            ]
        else:
    ...
    def test_basic_file_removal(self):
        ...
        self.run_script([
            str(self.csv_file),
            str(self.target_dir),
            '--dup-path', str(self.dup_dir)
        ])
        
        # Check that files marked for deletion were moved
        assert not (self.target_dir / "2020+/2022/2022-06/2022-06_Photos/photo1.jpg").exists()
        assert not (self.target_dir / "1990+/1995/1995-03/1995-03_Vacation/scan1.jpg").exists()
        assert not (self.target_dir / "2020+/2025/2025-10/NPTSTI~Z/duplicate.jpg").exists()
        ...
        assert moved_file.read_text() == "Test content for 2020+/2022/2022-06/2022-06_Photos/photo1.jpg"
    ...
    def test_dry_run_mode(self):
        ...
        assert (self.target_dir / "2020+/2022/2022-06/2022-06_Photos/photo1.jpg").exists()
        assert (self.target_dir / "1990+/1995/1995-03/1995-03_Vacation/scan1.jpg").exists()
    ...
    def test_missing_files(self):
        ...
        test_data = [
            ['Group ID', 'Filename', 'Folder', 'Size (KB)', 'Dimensions', 'Match %', 'Action', 'Comments'],
            ['0', 'nonexistent.jpg', 'X:\\2020+\\2022\\2022-06\\2022-06_Photos',
             '500', '1920 x 1080', '99', 'Delete', 'Missing file']
        ]
    ...
    def test_positional_arguments(self):
        ...
        assert "Successfully moved" in result.stdout or "No files needed" in result.stdout
    ...
    def test_no_delete_actions(self):
        ...
        test_data = [
            ['Group ID', 'Filename', 'Folder', 'Size (KB)', 'Dimensions', 'Match %', 'Action', 'Comments'],
            ['0', 'photo1.jpg', 'X:\\photos\\2020+\\2022\\2022-06\\2022-06_Photos', '500', '1920 x 1080', '99', 'Keep', 'Good file'],
            ['1', 'photo2.jpg', 'X:\\photos\\2020+\\2022\\2022-06\\2022-06_Photos', '600', '1920 x 1080', '98', 'Keep', 'Another good file']
        ]
        self.create_test_csv(test_data)
    ...
    def test_path_normalization(self):
        ...
        test_data = [
            ['Group ID', 'Filename', 'Folder', 'Size (KB)', 'Dimensions', 'Match %', 'Action', 'Comments'],
            ['0', 'test.jpg', 'X:\\photos\\2022\\vacation', '500', '1920 x 1080', '99', 'Delete', 'Windows path']
        ]
        self.create_test_csv(test_data)
    ...
    def test_malformed_csv_rows(self):
        ...
        test_data = [
            ['Group ID', 'Filename', 'Folder', 'Size (KB)', 'Dimensions', 'Match %', 'Action', 'Comments'],
            ['0', '', 'X:\\photos\\2020+\\2022', '500', '1920 x 1080', '99', 'Delete', 'Empty filename'],
            ['1', 'photo.jpg', '', '500', '1920 x 1080', '99', 'Delete', 'Empty folder'],
            ['2', 'normal.jpg', 'X:\\photos\\2020+\\2022', '500', '1920 x 1080', '99', 'Delete', 'Normal row']
        ]
        self.create_test_csv(test_data)
        ...
        result = self.run_script([
            ...
            str(self.target_dir),
            '--dup-path', str(self.dup_dir)
        ], expect_success=False)  # Expecting failure since file not found
    ...
    def test_keyboard_interrupt_handling(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            result = subprocess.run(
                ['python3', str(self.script_path), str(self.csv_file), str(self.target_dir)],
                capture_output=True, text=True
            )
            
            # Script should handle interrupt gracefully
            # Note: This test might be tricky due to subprocess handling
