...
pytestmark = pytest.mark.skipif(
    not HAS_PHOTO_ORGANIZER, 
    reason="PhotoOrganizer class not available for testing"
)
...
class TestPhotoOrganizer:
    ...
    def test_init(self, temp_dirs):
        ...
        assert organizer.stats == {'processed': 0, 'copied': 0, 'skipped': 0, 'errors': 0}
    ...
    def test_get_target_path(self, temp_dirs):
        ...
        expected_path = target_dir / "2020+" / "2023" / "2023-07" / "vacation_photos" / "beach_sunset.jpg"
    ...
    def test_get_target_path_invalid_date(self, temp_dirs):
        ...
        expected_path = target_dir / "1900+" / "1900" / "1900-01" / "photos" / "image.jpg"
        assert target_path == expected_path
