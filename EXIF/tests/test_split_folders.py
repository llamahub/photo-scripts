...
class TestSplitFolders(unittest.TestCase):
    ...
    def test_init(self):
        ...
        splitter = FolderSplitter(
            source_dir=self.test_dir, threshold=50, max_per_folder=50, dry_run=True
        )
    ...
    def test_empty_directory(self):
        ...
        )  # Source directory itself is scanned
    ...
    def test_small_folders_not_split(self):
        ...
        splitter = FolderSplitter(
            self.test_dir, threshold=50, dry_run=True, logger=self.mock_logger
        )
        splitter.run()
    ...
    def test_custom_threshold(self):
        ...
        splitter = FolderSplitter(
            self.test_dir, threshold=25, max_per_folder=10, dry_run=True
        )
