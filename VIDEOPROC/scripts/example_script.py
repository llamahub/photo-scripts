...
parsing pattern that all VIDEOPROC scripts should follow. It uses the shared
...
- Template patterns for all future VIDEOPROC script development

Follow this exact structure for all VIDEOPROC scripts to ensure consistency.
"""
...
def main():
    ...
    # Display configuration with VIDEOPROC-specific labels
    config_map = {
    ...
    try:
        ...
        # from VIDEOPROC.image_processor import ImageProcessor
        ...
        logger.info("Starting VIDEOPROC image processing")
        ...
        logger.info("Analyzing VIDEOPROC data for duplicate detection")
        logger.debug("Loading VIDEOPROC parser with GPS and timestamp support")  # DEBUG: implementation detail
        ...
        for src_file, dst_file in example_files:
            if dst_file:
                ...
                logger.debug("File size: 2.4MB, VIDEOPROC date: 2023-01-15 14:30:22")
        ...
        logger.info("VIDEOPROC image processing completed successfully")
